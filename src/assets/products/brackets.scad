 ...
 */
 ...
 Usage:
    The module has several parameter to change the bracket. The first value is default:
      ...
      - number_of_rails = 1
      - screw_hole_diameter_in_millimeter = 6.4
...
width_in_millimeter = 20; //[20,25,25.4,30,40,45,60,80,90,120,160]
...
length_in_millimeter = 60; //[1:200]

// The height/thickness of the bracket.
bracket_height_in_millimeter = 7.0; //[0.1:0.1:30]
...
// Set 4.3 for M4, 5.3 for M5, 6.4 for M6, 8.4 for M8, 10.5 for M10 screws
screw_hole_diameter_in_millimeter = 6.4;

// If you want to use a ISO7009/DIN125 washer, set 9.5 for M4, 10.5 for M5, 12.5 for M5, 16.5 for M8, 20.5 for M10... Or if you don't want to use a washer, just measure the diameter of the screw head and type it in here.
screw_head_offset_diamter_in_millimeter = 12.0;
...
// If you need only the outer holes, then set 0. But it also makes the short type brackets unsuable.
number_of_extra_holes = 1; //[0:1:4]
